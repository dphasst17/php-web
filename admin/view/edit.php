...
<div class="w-50 m-auto p-5 d-flex flex-column " >
      ...
      <input class="w-full p-[2%] rounded text-white"style="border:none;outline:none;cursor:pointer;" type="file" id="imageFile" name="imageFile"><br>
    
      <label class="text-white" for="url">Tải hình ảnh từ internet</label>
      <input value='<?php echo $getProduct['imgProduct']; ?>' class="w-full p-[2%] rounded"style="border:none;outline:none;cursor:pointer;" type="text" id="imageUrl" name="imageUrl"><br>
    
      <label class="text-white" for="name">Tên:</label>
      <input value='<?php echo $getProduct['nameProduct']; ?>' class="w-full p-[2%] rounded"style="border:none;outline:none;cursor:pointer;" type="text" id="name" name="name"><br>
      
      <label class="text-white" for="price">Đơn giá (USD):</label>
      <input value='<?php echo $getProduct['price']; ?>' class="w-full p-[2%] rounded"style="border:none;outline:none;cursor:pointer;" type="number" id="price" name="price"><br>

      <label class="text-white" for="des">Mô tả:</label>
      <textarea  class="w-full p-[2%] "style="border:none;outline:none;cursor:pointer;resize: none;" id="des" name="des" rows="5" cols="30" required><?php echo $getProduct['des']; ?></textarea><br><br>
      
      <label class="text-white" for="date">Ngày nhập:</label>
      <input value='<?php echo $getProduct['dateAdded']; ?>' class="w-full p-[2%] rounded"style="border:none;outline:none;cursor:pointer;" type="date" id="date" name="date"><br>
    
      <label class="text-white" for="category">Mã loại:</label>
      <select class="w-full p-[2%] rounded"style="border:none;outline:none;cursor:pointer;" id="category" name="category">
