    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full md:w-1/2 lg:w-1/3 px-4">
        <div class="max-w-[370px] mx-auto mb-10">
          <div class="rounded overflow-hidden mb-8">
            <img
              src="https://cdn.wccftech.com/wp-content/uploads/2019/06/238593-top-banner-3rd-gen-creative-x570-logo-1260x709.wdp_.png"
              alt="image"
          ...
          <div>
            <span
              class="bg-primary cursor-pointer rounded inline-block text-center py-1 px-4 text-xs leading-loose font-semibold text-white mb-5"
            >
              Dec 22, 2023
            </span>
            <h3>
      ...
      <div class="w-full md:w-1/2 lg:w-1/3 px-4">
        <div class="max-w-[370px] mx-auto mb-10">
          <div class="rounded overflow-hidden mb-8">
            <img
              src="https://no1computer.vn/upload_images/images/Tin%20t%E1%BB%A9c/T%C6%B0%20v%E1%BA%A5n/laptop%20gaming%2018%20tri%E1%BB%87u/laptop-gaming-18-trieu-h4.jpg"
              alt="image"
              class="w-full h-[200px] object-cover"
            />
          </div>
