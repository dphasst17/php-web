...
<div class="w-full xl:w-4/5 min-h-[300px] h-auto my-[2%] flex items-center justify-center mx-auto">
    <div id="productList" class="w-[90%] min-h-[300px] h-auto grid grid-cols-1 ssm:grid-cols-2 sm:grid-cols-4 gap-6 px-2"></div>
</div>
<script>
    ...
    const view = (e) => {
        let viewProduct = e.map(e => `<div class="items w-[22%] min-w-[150px] smr:min-w-[180px] md:min-w-[200px] h-2/4 flex flex-col flex-wrap items-center p-[1%] cursor-pointer hover:rounded-[5px] hover:bg-slate-300 transition-all" key=${e.idProduct}>
