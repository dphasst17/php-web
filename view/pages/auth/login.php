<div class="bg-blue-400 h-[100dvh] w-screen">
      <div
            ...
            <div class="flex flex-col flex-1 justify-center mb-8">
              ...
              <div class="w-full flex flex-col justify-around" style="height:85%">
                ...
                <div class="w-full flex flex-col items-center justify-center">
                  <div id="buttonDiv" class="w-full flex flex-col items-center justify-center"></div>
                  ...
                  <div class="w-64 h-10 bg-gray-900 text-gray-100 hover:text-white shadow font-bold text-sm py-1 px-3 rounded flex justify-start items-center cursor-pointer mt-2">
                  ...
                  <div onclick="HandleFacebookLogin()" class="w-64 h-10 bg-indigo-600 text-gray-100 hover:text-white shadow text-sm font-bold py-1 px-3 rounded flex justify-start items-center cursor-pointer mt-2">
...
<script src="https://accounts.google.com/gsi/client" async defer></script>
  <script>
    ...
    let idGoogle = <?php echo json_encode(getenv('ID_FB'));?>;
    let postData ={};
    ...
    window.onload = function () {
      google.accounts.id.initialize({
        client_id: '132575877421-gig4g2ahetogi4sr2071v1i3d4j1eifu.apps.googleusercontent.com',
      ...
      google.accounts.id.renderButton(
          document.getElementById("buttonDiv"),
          {
              ...
              height: "32",
              locale: "en",
              text: "signup_with", // Tùy chỉnh kiểu hiển thị chữ trên nút
          }
      );
